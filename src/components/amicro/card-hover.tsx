    ...
    <div className={`grid grid-cols-1 md:grid-cols-3 gap-4 w-full ${className}`}>
      {items.map((item, idx) => (
        ...
        >
          ...
          <div
            className={`rounded-2xl h-full w-full p-5 overflow-hidden bg-white dark:bg-black border border-neutral-200 dark:border-zinc-800 group-hover:border-slate-300 dark:group-hover:border-zinc-700 relative z-20 transition-colors duration-200 ${cardClassName}`}
          >
